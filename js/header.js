if(document.getElementById("header")){
    ...
    <div class="container">
      <a class="navbar-brand" href="index.html">
        <img src="images/Logo.svg" alt="logo" class="d-md-none" />
      </a>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-lg-0">
          <li class="nav-item py-3 bor-bottom-2">
            <a
              class="nav-link active text-white bor-left-1 fw-semibold fs-6 px-2 px-lg-4 py-0"
              aria-current="page"
              href="index.html"
              >Home</a
            >
          ...
          <li class="nav-item py-3 bor-bottom-2">
            <a
              class="nav-link text-white bor-left-1 fw-semibold fs-6 px-2 px-lg-4 py-0"
              href="Abouts.html"
              >About</a
            >
          </li>
          <li class="nav-item dropdown py-3 bor-bottom-2">
            <a
              class="nav-link dropdown-toggle text-white bor-left-1 fw-semibold fs-6 px-2 px-lg-4 py-0"
              href="#"
              role="button"
        ...
        <div class="d-md-flex align-items-center gap-2 gap-lg-5">
          <ul class="d-flex column-gap-4 align-items-center mb-2 ps-0">
            <li>
          ...
          <a
            class="btn bg-white p-3 rounded-0 btn-hov-pri fw-semibold fs-6"
          >
            Request Quote
          </a>
        </div>
